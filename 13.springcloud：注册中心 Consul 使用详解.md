>springcloud：注册中心 Consul 使用详解
转载 http://www.ityouknow.com/springcloud/2018/07/20/spring-cloud-consul.html
...
![img](http://favorites.ren/assets/images/2018/springcloud/consul-server-client.png)


Consul 工作原理：
![img](http://favorites.ren/assets/images/2018/springcloud/consol_service.png)
...
![img](http://favorites.ren/assets/images/2018/springcloud/consul_insall.png)


我这里以 Windows 为例，下载下来是一个 consul_1.2.1_windows_amd64.zip 的压缩包，解压是是一个 consul.exe 的执行文件。
![img](http://favorites.ren/assets/images/2018/springcloud/consul_win.png)
...
```
启动结果如下：
![img](http://favorites.ren/assets/images/2018/springcloud/consol_cmd.png)


启动成功之后访问：http://localhost:8500，可以看到 Consul 的管理界面

![img](http://favorites.ren/assets/images/2018/springcloud/consol_manage.png)
...
![img](http://favorites.ren/assets/images/2018/springcloud/consol_producer.png)


我们发现页面多了 service-producer 服务，点击进去后页面显示有两个服务提供者：
![img](http://favorites.ren/assets/images/2018/springcloud/consol_producer-2.png)
